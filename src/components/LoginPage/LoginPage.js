...
export const LoginPage = () => {
  ...
  return (
    <div className='loginpage-container'>
      <div className='loginpage-message-wrapper'>
      ...
      <div className='login-container'>
        ...
        <div className='login-app-buttons'>
          ...
          <div className='login-app-button google-button' onClick={() => { window.alert('login'); login() }}>
        ...
        <div className='login-check-container'>
          <input className="login-check-input" type="checkbox" id="rememberMe" data-gtm-form-interact-field-id="0" />
          <label className="login-check-label" htmlFor="rememberMe">Remember me</label>
        </div>
