...
const Response = ({ chat, icon }) => {
  console.log(chat);
  return (
    <div className={`user-chat-container ${chat.user}`}>
      ...
      <div
        className={`user-chat-value ${
          chat.response === "Generating" && "generating"
        }`}>
        {chat.response}
      </div>
    </div>
...
const GPT = ({ user, setUser }) => {
  const [activeModel, setActiveModel] = useState("ChatGPT 3.5");
  ...
  return (
    <div className="home-container container">
      <div className="header">
        <div class="heading">Percy GPT</div>
        <div className="dropdown-container">
          <div
            ...
            <svg
              ...
              viewBox="0 0 16 17"
              fill="none"
              className={`down-arrow ${isDropDownOpen && "reverse"}`}>
              <path
            ...
            <div
              ...
              <div
                ...
                <div className="dropdown-item">
                  <div className="dropdown-item-title">GPT - 3.5</div>
                  <div className="dropdown-item-value">Basic Model</div>
                </div>
                <div className="dropdown-checkbox">
                  {activeModel === "ChatGPT 3.5" ? (
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
              ...
              <div
                ...
                <div className="dropdown-item">
                  <div className="dropdown-item-title">GPT - 4</div>
                  <div className="dropdown-item-value">
                    Thanks to Abhi Patil
                  </div>
                </div>
                <div className="dropdown-checkbox">
                  {activeModel === "ChatGPT 4" ? (
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
